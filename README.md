...
The main goal of the application to combine multiple communication paradigms such as REST and message-passing.

## Architecture 
The three microservices, inventory-management, machine-management, and order-management each have their own functionality and architecture within the system.
...
![overviewArchitecture](./docs/diagrams/PMS-Overview.png)

## Deployment
All microservices can be deployed independently. To do so follow the instructions of the individual microservices.
